...
/**
 * Entity for information about rights of official on his things
 * 
 * @author cortes
 *
 */
public class ShortRights {
	...
	public String getUaFullName() {
		return uaFullName;
	}

	public void setUaFullName(String uaFullName) {
